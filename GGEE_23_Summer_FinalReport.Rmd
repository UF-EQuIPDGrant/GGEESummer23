...
*Challenges faced, lessons leared, and adaptations.* 

- Virtual Interviews - internet connection, authentic responses, quiet connected places for interviews 
- Virtual Observations - hard to tell what is going on in the classroom, no time to properly train students in observation protocols. Need to incorporate that into the training program in addition to learning the content
- Student recruitment - delays from HR and confirmation of funding to support student mentors
- Ensure no tasks are implied tasks for teacher prep - attendance, student drop off and pick up etc. 
- Parent documents - have the documents be a requirement for registration instead of having 2 surveys
- Youth Compliance - uploading students and teachers in to the portal - identifying all required versus suggested information
...
- Updating compliance forms with more clear language for parent and the research study
